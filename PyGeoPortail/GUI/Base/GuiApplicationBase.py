...
from PyGeoPortail.Application.ApplicationBase import ApplicationBase
from PyGeoPortail.GUI.Forms.CriticalErrorForm import CriticalErrorForm
import PyGeoPortail.Config.Config as Config
import PyGeoPortail.Config.Messages as Messages
import PyGeoPortail.Version as Version

# Load RC
#import PyGeoPortail.gui.ui.pygeoportail_rc
...
class GuiApplicationBase(ApplicationBase, QtWidgets.QApplication):
    ...
    def _display_splash_screen(self):
        ...
        self._splash.show()
        self._splash.showMessage('<h2>PyGeoPortail %(version)s</h2>' % {'version':str(Version.pygeoportail)})
        self.processEvents()
    ...
    def _init_actions(self):
        ...
        self.about_action = \
            QtWidgets.QAction('About PyGeoPortail',
                          self,
    ...
    def post_init(self):
        ...
        self.show_message('Welcome to PyGeoPortail')
    ...
    def critical_error(self, title='PyGeoPortail Critical Error', message=''):
    ...
    def open_help(self):
        ...
        url.setPath(Config.Help.url_path_pattern) # % str(Version.pygeoportail))
    ...
    def about(self):
        ...
        message = Messages.about_pygeoportail % {'version':str(Version.pygeoportail)}
        QtWidgets.QMessageBox.about(self.main_window, 'About PyGeoPortail', message)
    ...
    def show_system_information(self):
        ...
        fields.update({
                'pygeoportail_version': str(Version.pygeoportail),
                })  
