...
from PyGeoPortail.Logging.Email import Email
from PyGeoPortail.Tools.Platform import Platform
from PyGeoPortail.Tools.Singleton import singleton
...
class EmailExceptionHook(ExceptionHook):
    ...
    def notify(self, exception_type, exception_value, exception_traceback):
        ...
        template_message = '''
Object: An exception occurred in PyGeoPortail software on %(date)s UTC
...
'''   
        ...
        email = Email(subject='An exception occurred in PyGeoPortail software',
