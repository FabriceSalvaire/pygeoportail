...
from PyGeoPortail.Logging.ExceptionHook import DispatcherExceptionHook, StderrExceptionHook, EmailExceptionHook
from PyGeoPortail.Tools.Singleton import singleton
import PyGeoPortail.Config.ConfigInstall as ConfigInstall
