...
void main()
{
  ...
  int label = label_texel.r;

  int random_label_texture_size = textureSize(random_label_texture, 0); // 4000 < s < 5000
  int red_offset = 0;
  ...
  colour_texel = texelFetch(random_label_texture, texture_index, 0) + sin(float(texture_index));
